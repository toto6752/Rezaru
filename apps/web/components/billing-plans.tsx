...
export function BillingPlans({ currentPlan, developmentMode }: { currentPlan: string; developmentMode: boolean }) {
  ...
  return <div className="billing-content">
    ...
    <div className="business-plan"><div><span>BUSINESS</span><h3>Private cloud, SSO, custom limits, and an SLA.</h3></div><a className="button button-secondary" href="mailto:sales@rezaru.dev">Contact sales</a></div>
  </div>;
}
