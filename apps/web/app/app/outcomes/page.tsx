...
export default async function OutcomesPage() {
  ...
  return <div className="list-page">
    <header className="page-header"><div><span className="page-eyebrow">AUTOMATED OPERATIONS</span><h1>Outcomes</h1><p>Business results that Rezaru creates, runs, and improves.</p></div><Link className="button button-primary" href="/app/outcomes/new"><Plus size={15} /> Create outcome</Link></header>
    ...
    </Link>)}</div> : <div className="dashboard-panel"><EmptyState icon={<Zap size={21} />} title="Define your first outcome" description="Describe repetitive business work. Rezaru will ask for only the details it needs and create a plan you can test." action={<Link className="button button-primary" href="/app/outcomes/new"><Plus size={15} /> Create outcome</Link>} /></div>}
  </div>;
}
